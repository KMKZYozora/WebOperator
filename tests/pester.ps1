...
Remove-Module WebOperator -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\WebOperator\WebOperator.psd1"
Import-Module "$PSScriptRoot\..\WebOperator\WebOperator.psm1" -Force
