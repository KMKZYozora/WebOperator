...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\WebOperator\functions", "$global:testroot\..\WebOperator\internal\functions"),
	
	[string]
	$ModuleName = "WebOperator",
...
$CommandPath = @(
    "$global:testroot\..\WebOperator\functions"
    "$global:testroot\..\WebOperator\internal\functions"
)
